...
const AmazonSection = () => {
  return (
    <>
      <div className="bg-sidebarColor rounded w-full mt-8 border-t-2 border-green-500 h-[15vh]">
      ...
      <div className="bg-sidebarColor rounded w-full border-t-2 border-green-500 h-[16vh]">
        <div className=" flex justify-between ml-4 mt-4">
          <h1 className=" font-semibold text-[16px]">
            Creating payouts<span className="flex flex-col">in Live mode</span>
          </h1>
          <div className=" ml-36">
          ...
          <div className="flex flex-col mr-24">
            ...
            <div className="flex flex-col">
              <span className=" text-[13px] font-semibold">Create payout</span>
